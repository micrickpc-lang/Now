...
export type AuthIdentityMinAggregateOutputType = {
  id: string | null
  userId: string | null
  provider: $Enums.AuthIdentityProvider | null
...
export type AuthIdentityGroupByOutputType = {
  id: string
  userId: string
  provider: $Enums.AuthIdentityProvider
  subjectHash: string
  createdAt: Date
  updatedAt: Date
  _count: AuthIdentityCountAggregateOutputType | null
...
export type AuthIdentityWhereInput = {
  ...
  provider?: Prisma.EnumAuthIdentityProviderFilter<"AuthIdentity"> | $Enums.AuthIdentityProvider
  subjectHash?: Prisma.StringFilter<"AuthIdentity"> | string
...
export type AuthIdentityWhereUniqueInput = Prisma.AtLeast<{
  id?: string
  provider_subjectHash?: Prisma.AuthIdentityProviderSubjectHashCompoundUniqueInput
  AND?: Prisma.AuthIdentityWhereInput | Prisma.AuthIdentityWhereInput[]
  OR?: Prisma.AuthIdentityWhereInput[]
  NOT?: Prisma.AuthIdentityWhereInput | Prisma.AuthIdentityWhereInput[]
  userId?: Prisma.UuidFilter<"AuthIdentity"> | string
...
export type AuthIdentityScalarWhereWithAggregatesInput = {
  ...
  provider?: Prisma.EnumAuthIdentityProviderWithAggregatesFilter<"AuthIdentity"> | $Enums.AuthIdentityProvider
  subjectHash?: Prisma.StringWithAggregatesFilter<"AuthIdentity"> | string
...
export type AuthIdentityUpdateInput = {
  ...
  provider?: Prisma.EnumAuthIdentityProviderFieldUpdateOperationsInput | $Enums.AuthIdentityProvider
...
export type AuthIdentityProviderSubjectHashCompoundUniqueInput = {
  provider: $Enums.AuthIdentityProvider
  subjectHash: string
}
...
export type EnumAuthIdentityProviderFieldUpdateOperationsInput = {
  set?: $Enums.AuthIdentityProvider
}
...
export type AuthIdentityOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "provider" | "subjectHash" | "createdAt" | "updatedAt", ExtArgs["result"]["authIdentity"]>
...
export interface AuthIdentityFieldRefs {
  ...
  readonly provider: Prisma.FieldRef<"AuthIdentity", 'AuthIdentityProvider'>
  readonly subjectHash: Prisma.FieldRef<"AuthIdentity", 'String'>
